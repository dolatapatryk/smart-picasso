...
class ProjectView(tk.Frame, AbstractView):
    ...
    def start(self):
        ...
        filename = self.project_name + '.png'
    ...
    def save(self):
        self.canvas.postscript(file=self.project_name + '.eps')
        img = PIL.Image.open(self.project_name + '.eps')
        img.save(self.project_name + '.png', 'png')
        os.remove(self.project_name + '.eps')
